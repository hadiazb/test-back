...
import { PlansPet as _PlansPet } from './PlansPet';
import type {
	PlansPetAttributes,
	PlansPetCreationAttributes,
} from './PlansPet';
...
export function initModels(sequelize: Sequelize) {
	...
	const PlansPet = _PlansPet.initModel(sequelize);
	...
	Insurances.belongsTo(PlansPet, { as: 'PlansPet', foreignKey: 'PlansPet_Id' });
	PlansPet.hasMany(Insurances, { as: 'Insurances', foreignKey: 'PlansPet_Id' });
	...
	Users.hasMany(UserScore, { as: 'IdUser_UserScores', foreignKey: 'IdUser' });
