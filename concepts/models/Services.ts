...
import type { TypeService, TypeServiceId } from './TypeService';
...
export type ServicesOptionalAttributes = "Id" | "Name" | "RegistrationDate" | "Id_Old" | "IdDomiciliary" | "deliveryNumber" | "IdSubsidiary" | "IsActive" | "PaymentType" | "TotalCost" | "Comission" | "LatitudeDomiciliary" | "LongitudeDomiciliary" | "UpdateDate" | "IsDeleted";
...
export class Services extends Model<ServicesAttributes, ServicesCreationAttributes> implements ServicesAttributes {
  ...
  // Services belongsTo TypeService via IdTypeService
  IdTypeService_TypeService!: TypeService;
  getIdTypeService_TypeService!: Sequelize.BelongsToGetAssociationMixin<TypeService>;
  setIdTypeService_TypeService!: Sequelize.BelongsToSetAssociationMixin<TypeService, TypeServiceId>;
  createIdTypeService_TypeService!: Sequelize.BelongsToCreateAssociationMixin<TypeService>;
