...
export interface SubsidiaryAttributes {
  ...
  ClosedByAffiliate?: boolean;
  Open?: boolean;
  CostDomiciliary?: string;
}

export type SubsidiaryPk = "Id";
export type SubsidiaryId = Subsidiary[SubsidiaryPk];
export type SubsidiaryOptionalAttributes = "Id" | "Name" | "RequestDomiciliary" | "IsActive" | "Phone" | "Address" | "Id_Old" | "DomicileValue" | "MarketingType" | "MinDomicileValue" | "ClosedByAdmin" | "TimeDelivery" | "ScheduledShipping" | "OwnDomicile" | "SelfService" | "DeductedMarket" | "FreeShipping" | "Longitude" | "Latitude" | "CreateDate" | "IsDeleted" | "DeliveryService" | "CustomerShipping" | "ClosedByAffiliate" | "Open" | "CostDomiciliary";
