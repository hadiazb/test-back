...
import type { StoryDelivery, StoryDeliveryId } from './StoryDelivery';
...
export type UsersOptionalAttributes = "Id" | "Name" | "LastName" | "Email" | "RegistrationDate" | "Phone" | "ProfilePhoto" | "IsActive" | "InvitationCode" | "VirtualWallet" | "BirthDate" | "MarketId" | "Admin" | "Address" | "Gender" | "TypeUser" | "LicenseValidity" | "AccountNumber" | "Coordinator" | "IdCity" | "haveDatafono" | "IdMarket" | "Verified" | "Id_Old" | "TokenPush" | "Longitude" | "Latitude" | "Instructions" | "Password" | "IsDeleted";
...
export class Users extends Model<UsersAttributes, UsersCreationAttributes> implements UsersAttributes {
  ...
  // Users hasMany MarketScore via IdUser
  ...
  // Users hasMany StoryDelivery via Users_Id
  StoryDeliveries!: StoryDelivery[];
  getStoryDeliveries!: Sequelize.HasManyGetAssociationsMixin<StoryDelivery>;
  setStoryDeliveries!: Sequelize.HasManySetAssociationsMixin<StoryDelivery, StoryDeliveryId>;
  addStoryDelivery!: Sequelize.HasManyAddAssociationMixin<StoryDelivery, StoryDeliveryId>;
  addStoryDeliveries!: Sequelize.HasManyAddAssociationsMixin<StoryDelivery, StoryDeliveryId>;
  createStoryDelivery!: Sequelize.HasManyCreateAssociationMixin<StoryDelivery>;
  removeStoryDelivery!: Sequelize.HasManyRemoveAssociationMixin<StoryDelivery, StoryDeliveryId>;
  removeStoryDeliveries!: Sequelize.HasManyRemoveAssociationsMixin<StoryDelivery, StoryDeliveryId>;
  hasStoryDelivery!: Sequelize.HasManyHasAssociationMixin<StoryDelivery, StoryDeliveryId>;
  hasStoryDeliveries!: Sequelize.HasManyHasAssociationsMixin<StoryDelivery, StoryDeliveryId>;
  countStoryDeliveries!: Sequelize.HasManyCountAssociationsMixin;
  ...
  removeUserScore!: Sequelize.HasManyRemoveAssociationMixin<UserScore, UserScoreId>;
  removeUserScores!: Sequelize.HasManyRemoveAssociationsMixin<UserScore, UserScoreId>;
  ...
  IdUserDomiciliary_UserScores!: UserScore[];
  getIdUserDomiciliary_UserScores!: Sequelize.HasManyGetAssociationsMixin<UserScore>;
  setIdUserDomiciliary_UserScores!: Sequelize.HasManySetAssociationsMixin<UserScore, UserScoreId>;
  addIdUserDomiciliary_UserScore!: Sequelize.HasManyAddAssociationMixin<UserScore, UserScoreId>;
  addIdUserDomiciliary_UserScores!: Sequelize.HasManyAddAssociationsMixin<UserScore, UserScoreId>;
  createIdUserDomiciliary_UserScore!: Sequelize.HasManyCreateAssociationMixin<UserScore>;
  removeIdUserDomiciliary_UserScore!: Sequelize.HasManyRemoveAssociationMixin<UserScore, UserScoreId>;
  removeIdUserDomiciliary_UserScores!: Sequelize.HasManyRemoveAssociationsMixin<UserScore, UserScoreId>;
  hasIdUserDomiciliary_UserScore!: Sequelize.HasManyHasAssociationMixin<UserScore, UserScoreId>;
  hasIdUserDomiciliary_UserScores!: Sequelize.HasManyHasAssociationsMixin<UserScore, UserScoreId>;
  countIdUserDomiciliary_UserScores!: Sequelize.HasManyCountAssociationsMixin;
  ...
  removeVehicles!: Sequelize.HasManyRemoveAssociationsMixin<Vehicles, VehiclesId>;
